    ...
    private class TwitterTask extends AsyncTask<String, Void, List<twitter4j.Status>> {
        ...
        protected List<twitter4j.Status> doInBackground(String... hashTag) {
            ...
            cb.setDebugEnabled(true)
                    .setOAuthConsumerKey("rUbrLC2IfjQYnExufP06YY3VP")
                    .setOAuthConsumerSecret("PJk6cIlvzBVVHl8DmzwyvXtz2NYBm9uRBWerrbkHAOYAITbgQQ")
                    .setOAuthAccessToken("933365799586328576-n7G36x6VwQ6Mdp3JoSvMx8OGMvQexbW")
                    .setOAuthAccessTokenSecret("Fo54ZXIFqYZpXB9baAA0OdHsqWS1wpbFyiwQ51ZcPkGzd");
